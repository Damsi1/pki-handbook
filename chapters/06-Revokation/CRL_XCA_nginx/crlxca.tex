    ...
    \section{Anpassung des Serverzertifikats in XCA}
...
http://192.168.1.1/crl/cacrl.pem
    ...
    \section{Widerruf des Serverzertifikats}
    ...
    \section{Erstellen der CRL des Intermediate-Zertifikats}
...
cacrl.pem
    ...
    \section{Bereitstellen der CRL über Nginx}

    \subsection{Ablage der CRL auf dem Webserver}
...
sudo systemctl restart nginx
    ...
    \section{Überprüfung im Browser}
...
http://192.168.1.1/crl/cacrl.pem
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\textwidth]{xcacrl3}
        \caption*{Anzeige der CRL-URL im Browser}
    \end{figure}
