...
\newcommand{\thesistitle}{\LARGE\textbf{PKI Handbuch} \\[0.1em] \large PKI-Aufbau mit XCA und TLS-Bereitstellung auf Nginx}


%%\newcommand{\thesistitletranslated}{Smart Safety \& Monitoring System}
\newcommand{\thesistitletranslated}{\LARGE\textbf{PKI Handbook} \\[0.1em] \large Building a PKI with XCA and TLS deployment on Nginx}
...
\include{chapters/06-Revokation/index}
\include{chapters/07-resources/index}
